      ...
      <div className="content-max-width">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-6">
            <span className="px-3 py-1 rounded-lg bg-teal-500/10 text-teal-500 text-[10px] font-bold uppercase tracking-widest border border-teal-500/20">
              {selectedFirm.name}
            </span>
          ...
          <h1 className="text-4xl font-bold text-white mb-4">
            Select <span className="text-teal-400">Bill Type</span>
          </h1>
