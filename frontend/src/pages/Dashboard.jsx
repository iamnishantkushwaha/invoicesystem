        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-white/5">
          <div className="space-y-1">
            <h1 className="text-3xl font-bold text-theme-primary tracking-tight">
              Select <span className="text-theme-teal">Firm</span>
            </h1>
            <p className="text-theme-secondary text-sm">Choose an entity to start generating invoices</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="p-3 rounded-xl bg-white/5 hover:bg-red-500/10 text-theme-muted hover:text-red-500 transition-all border border-white/10"
              title="Logout"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="w-full max-w-lg card-modern !p-8 space-y-6 shadow-[0_0_50px_rgba(0,0,0,0.5)] border-white/20">
            <div className="flex justify-between items-center border-b border-white/10 pb-4">
              <h2 className="text-xl font-bold text-theme-primary">Register <span className="text-theme-teal">Firm</span></h2>
              <button onClick={() => setIsModalOpen(false)} className="text-theme-muted hover:text-theme-primary transition-colors">
